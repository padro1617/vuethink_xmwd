...
import structuresConfig from './components/Administrative/structures/structures/config.vue'
...
const routes = [
  ...
  },
  {
    ...
    component: Home,
    children: [
      { path: 'structures/config', component: structuresConfig, name: 'structuresConfig', meta: { hideLeft: false, module: 'Administrative', menu: 'structures' }},
