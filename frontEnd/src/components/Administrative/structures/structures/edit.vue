<template>
  <div class="m-l-50 m-t-30 w-900">
    <el-form ref="form" :model="form" :rules="rules" label-width="130px">
      <el-form-item label="机型" prop="name">
        <el-input v-model.trim="form.name" class="h-40 w-200"></el-input>
			...
			<el-form-item label="规格" prop="guige">
				<el-input v-model.trim="form.guige" class="h-40 w-200"></el-input>
			</el-form-item>
			<el-form-item label="回收价格" prop="prize">
				<el-input v-model.trim="form.prize" class="h-40 w-200"></el-input>
			</el-form-item>
      ...
      <!-- <el-form-item label="父级机型" prop="pid">
        <el-select v-model="form.pid" placeholder="父级机型" class="w-200">
      ...
      getStructureInfo() {
        ...
        this.apiGet('admin/structures/' + this.form.id).then((res) => {
          this.handelResponse(res, (data) => {
            ...
            this.form.guige = data.guige
            this.form.prize = data.prize
